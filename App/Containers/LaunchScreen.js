    ...
    if (coins.fetching === false) {
      return (
        ...
        <SafeAreaView showsVerticalScrollIndicator={false} style={{ backgroundColor: graphData && graphData.color !== null ? graphData.color : colors.ember }}>
          ...
          {graphData && <Button onPress={() => this.props.navigation.navigate('DetailScreen', {id: graphData.id, base: base, timePeriod: timePeriod, color: graphData.color})} buttonStyle={{backgroundColor: colors.transparent, borderColor: colors.silver, borderWidth: 2, marginVertical: 10, paddingHorizontal: 30, width: '80%', alignSelf: 'center'}} title={'Know More about ' + graphData.name} titleStyle={{color: colors.silver, fontWeight: 'bold'}} />}
          ...
          <View style={{ flexDirection: 'column',justifyContent: 'space-around', flex: 1, backgroundColor: colors.transparent }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-around', padding: 10, backgroundColor: colors.transparent}} >
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-around', backgroundColor: colors.transparent, padding: 10}} >
